...
提议的标准定义了一个轻量级接口，用于公开持有代币的功能性所有权和余额。持有代币是由合约拥有的代币。该标准可以由持有 [EIP-20](./eip-20.md)、[EIP-721](./eip-721.md) 或 [EIP-1155](./eip-1155.md) 代币的智能合约实现，旨在被依赖于所有权和余额验证的链上和链下系统使用。

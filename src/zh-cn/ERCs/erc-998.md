...
对 [ERC-721 标准](./eip-721.md) 的扩展，以使 ERC-721 代币能够拥有其他 ERC-721 代币和 [ERC-20](./erc-20.md) 代币。

对 [ERC-20](./erc-20.md) 和 `ERC-223 https://github.com/ethereum/EIPs/issues/223` 标准的扩展，以使 ERC-20 和 `ERC-223` 代币能够被 ERC-721 代币拥有。
...
`ERC998ERC20` 自下而上的可组合合约必须实现 [ERC-20 接口](./erc-20.md)。

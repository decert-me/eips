...
本 ERC 标准化了一个合约层共识无关的可验证跨链桥接接口，通过该接口，我们可以在多条链上定义一个新的全球代币，继承自 [ERC-20](./eip-20.md)/[ERC-721](./eip-721.md)。
...
ERC-6358 代币可以使用上述提到的 [接口](#smart-contract-interface) 实现。它也可以与 [ERC-20](./eip-20.md)/[ERC-721](./eip-721.md) 结合使用。
